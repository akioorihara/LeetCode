...
workflow.Add(new UploadVideo("C:\\current\\directory"));
workflow.Add(new EmailNotifications(new Email("test@test.com", "test subject")));
...
workflow.Add(new TextNotifications());
